...
def find_all_occurances(arr,numb_to_find):
    index=binary_search(arr,numb_to_find)
    indeces=[index]
    i=index-1 
    while arr[i]==arr[index] and i>=0:
        indeces.append(i)
        i=i-1 
    
    i=index+1 
    while arr[i]==arr[index] and i<len(arr):
        indeces.append(i)
        i=i+1 
...
if __name__=='__main__':
    arr= [15,15,15,15,15,15,15,15,17,21,34,34,56]
    # print(binary_search(arr,15)) 
    print(find_all_occurances(arr,15))